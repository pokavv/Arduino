...
| 딥슬립 | 문서화 | [esp32c3/09_deepsleep.md](docs/esp32c3/09_deepsleep.md) |
| NVS 플래시 저장 | 문서화 | [esp32c3/08_storage.md](docs/esp32c3/08_storage.md) |
...
| BLE 스마트폰 제어 | BLE | 예정 |
| MQTT 센서 노드 | Wi-Fi, MQTT, 딥슬립 | 예정 |
| OTA 업데이트 기본 | Wi-Fi, OTA | 예정 |
