...
export const SEED_COMPONENTS: Omit<ComponentDef, '_createdAt' | '_updatedAt' | '_builtIn'>[] = [
  ...
  // ── 저항 ──────────────────────────────────────────────────────────────────
  {
    ...
    pins: [
      { name: 'PIN1', label: '1', x: 0,   y: 21, type: 'signal', required: true, description: '리드선 1', compatibleWith: ['digital','analog','pwm','signal','power','ground','output','input'] },
      { name: 'PIN2', label: '2', x: 105, y: 21, type: 'signal', required: true, description: '리드선 2', compatibleWith: ['digital','analog','pwm','signal','power','ground','output','input'] },
    ],
  ...
  // ── 버튼 ──────────────────────────────────────────────────────────────────
  {
    ...
    pins: [
      { name: 'PIN1A', label: '1A', x: 21, y: 80, type: 'signal', required: false, description: '1번쪽 단자 A', compatibleWith: ['digital','signal','input'] },
      { name: 'PIN1B', label: '1B', x: 30, y: 80, type: 'signal', required: false, description: '1번쪽 단자 B (1A와 내부 연결)', compatibleWith: ['digital','signal'] },
      { name: 'PIN2A', label: '2A', x: 45, y: 80, type: 'ground', required: false, description: '반대쪽 단자 A', compatibleWith: ['ground','digital','signal'] },
      { name: 'PIN2B', label: '2B', x: 54, y: 80, type: 'ground', required: false, description: '반대쪽 단자 B (2A와 내부 연결)', compatibleWith: ['ground','digital','signal'] },
    ],
  ...
  // ── 포텐셔미터 ─────────────────────────────────────────────────────────────
  {
    ...
    pins: [
      { name: 'VCC',   label: 'VCC', x: 24, y: 96, type: 'power',  required: true, description: 'VCC',                      compatibleWith: ['power'] },
      { name: 'WIPER', label: 'W',   x: 45, y: 96, type: 'analog', required: true, description: '와이퍼 출력 — ADC 핀 연결', compatibleWith: ['analog'] },
      { name: 'GND',   label: 'GND', x: 66, y: 96, type: 'ground', required: true, description: 'GND',                      compatibleWith: ['ground'] },
    ],
  ...
  // ── DHT22 ─────────────────────────────────────────────────────────────────
  {
    ...
    pins: [
      { name: 'VCC',  label: 'VCC',  x: 15, y: 120, type: 'power',   required: true, description: 'VCC (3.3~5V)', compatibleWith: ['power'] },
      { name: 'DATA', label: 'DATA', x: 33, y: 120, type: 'digital', required: true, description: '데이터 + 4.7kΩ 풀업 필수', compatibleWith: ['digital','signal'] },
      { name: 'GND',  label: 'GND',  x: 51, y: 120, type: 'ground',  required: true, description: 'GND', compatibleWith: ['ground'] },
    ],
  ...
  // ── OLED ──────────────────────────────────────────────────────────────────
  {
    ...
    pins: [
      { name: 'GND', label: 'GND', x: 18, y: 80, type: 'ground',  required: true, description: 'GND', compatibleWith: ['ground'] },
      { name: 'VCC', label: 'VCC', x: 36, y: 80, type: 'power',   required: true, description: '3.3V 또는 5V', compatibleWith: ['power'] },
      { name: 'SCL', label: 'SCL', x: 54, y: 80, type: 'i2c_scl', required: true, description: 'I2C SCL', compatibleWith: ['i2c_scl','digital'] },
      { name: 'SDA', label: 'SDA', x: 72, y: 80, type: 'i2c_sda', required: true, description: 'I2C SDA', compatibleWith: ['i2c_sda','digital'] },
    ],
