...
export const SEED_COMPONENTS: Omit<ComponentDef, '_createdAt' | '_updatedAt' | '_builtIn'>[] = [
  ...
  // ── 버튼 ──────────────────────────────────────────────────────────────────
  {
    ...
    pins: [
      { name: 'PIN1A', label: '1A', x: 17, y: 80, type: 'signal', required: false, description: '1번쪽 단자 A', compatibleWith: ['digital','signal','input'] },
      { name: 'PIN1B', label: '1B', x: 27, y: 80, type: 'signal', required: false, description: '1번쪽 단자 B (1A와 내부 연결)', compatibleWith: ['digital','signal'] },
      { name: 'PIN2A', label: '2A', x: 48, y: 80, type: 'ground', required: false, description: '반대쪽 단자 A', compatibleWith: ['ground','digital','signal'] },
      { name: 'PIN2B', label: '2B', x: 59, y: 80, type: 'ground', required: false, description: '반대쪽 단자 B (2A와 내부 연결)', compatibleWith: ['ground','digital','signal'] },
    ],
  ...
  // ── OLED ──────────────────────────────────────────────────────────────────
  {
    ...
    pins: [
      { name: 'GND', label: 'GND', x: 14, y:  0, type: 'ground',  required: true, description: 'GND', compatibleWith: ['ground'] },
      { name: 'VCC', label: 'VCC', x: 28, y:  0, type: 'power',   required: true, description: '3.3V 또는 5V', compatibleWith: ['power'] },
      { name: 'SCL', label: 'SCL', x: 42, y:  0, type: 'i2c_scl', required: true, description: 'I2C SCL', compatibleWith: ['i2c_scl','digital'] },
      { name: 'SDA', label: 'SDA', x: 56, y:  0, type: 'i2c_sda', required: true, description: 'I2C SDA', compatibleWith: ['i2c_sda','digital'] },
    ],
